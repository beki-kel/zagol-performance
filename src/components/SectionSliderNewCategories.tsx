...
const SectionSliderNewCategories: FC<SectionSliderNewCategoriesProps> = ({
  heading = "Attractions",
  subHeading = "Discover all of Zagol's refined attraction blogs. Click on any card below to access comprehensive details.",
  className = "",
  itemClassName = "",
  ...
  return (
    <div className={` nc-SectionSliderNewCategories ${className}`}>
      <Heading isCenter={sliderStyle === "style2"} desc={subHeading}>
        {heading}
      </Heading>
      <MotionConfig
        transition={{
